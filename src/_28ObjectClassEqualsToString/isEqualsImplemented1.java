...
class Computer {
    ...
    public boolean equals(Computer obj) {  //Computer is class and obj is varibale 
        if (this == obj)
            return true;
        if (obj == null)
            return false;
        ...
        //we have to use "this" for class name(Computer) and we can change variable name "that" to anything - here we use obj for that
